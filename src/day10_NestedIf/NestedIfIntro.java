...
//has preconditions: in order for score to be considered to be passed or failed it has to be valid score
    //if score is 170 that should be considered invalid
    public static void main(String[] args) {

        int score = 400;

            if(score>= 0 && score <= 100){ // precondition - if score is valid
