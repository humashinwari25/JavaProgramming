...
public class ReplaceAll {
    ...
    public static void main(String[] args) {
        ...
        int[] arr = {10, 20,30,30,40,30,30,30};
        //            0   1  2  3   4 5  6  7
    ...
    // replaces ALL the matching old values of the array with the new value-for double variable
    ...
    // replaces ALL the matching old values of the array with the new value-for char variable
    ...
    // replaces ALL the matching old values of the array with the new value-for String variable
